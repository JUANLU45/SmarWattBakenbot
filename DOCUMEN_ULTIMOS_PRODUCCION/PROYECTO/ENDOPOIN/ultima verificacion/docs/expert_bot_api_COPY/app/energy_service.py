...
class EnergyService:
    ...
    def _log_uploaded_document_to_bigquery_enterprise(
        ...
        try:
            ...
            row = {
                ...
                "extracted_data_cups_ref": extraction_result.data.get("cups"),
                "extracted_data_postal_code_ref": extraction_result.data.get(
                    "codigo_postal"
                ),
                ...
                "enterprise_processing_version": "v1.0",
                "data_validation_passed": extraction_result.extraction_status
                != "partial",
            }
    ...
    def _update_user_energy_profile_enterprise(
        ...
        try:
            ...
            logging.info(f"🏢 Perfil empresarial actualizado para {user_id}")
    ...
    def _get_user_energy_profile_enterprise(self, user_id: str) -> Dict[str, Any]:
        """🏢 Obtener perfil energético empresarial con cache"""
        ...
        try:
            ...
            doc_ref = self.db.collection("user_energy_profiles").document(user_id)
            doc = doc_ref.get()
            ...
            if doc.exists:
                ...
                logging.info(f"🏢 Perfil empresarial obtenido para {user_id}")
                return profile_data
            else:
    ...
    def _get_user_documents(self, user_id: str) -> List[Dict[str, Any]]:
        ...
        try:
            # Query real a BigQuery para obtener documentos del usuario
            query = f"""
                SELECT 
                    document_id,
                    original_filename,
