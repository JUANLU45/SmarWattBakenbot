...
# 🔗 IMPORTAR SERVICIO DE ENLACES EMPRESARIAL
try:
    from app.services.enterprise_links_service import get_enterprise_link_service
except ImportError:
    try:
        from .enterprise_links_service import get_enterprise_link_service
    except ImportError:
        get_enterprise_link_service = None  # type: ignore
        logging.warning("🔴 EnterpriseLinkService no disponible")
...
class ChatService:
    ...
    def __init__(self, energy_ia_api_url: str) -> None:
        ...
        logging.info("� Servicio de enlaces deshabilitado en Expert Bot para evitar redundancia")
    ...
    def _get_user_context_for_welcome(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            context = {
                "user_name": user_data.get("displayName", "") or user_data.get("email", ""),
                "has_data": True,
    ...
    def _generate_personalized_welcome(self, user_context: Dict[str, Any]) -> Dict[str, Any]:
...
¿En qué puedo ayudarte hoy?"""
    ...
    def process_user_message(
        ...
        try:
            ...
            # 🔗 6.1 MEJORA EMPRESARIAL CON ENLACES INTELIGENTES
            if self.links_service and enhanced_response.get("response"):
                enhanced_response_with_links = (
                    self.links_service.analyze_and_enhance_response(
                        enhanced_response["response"]
                    )
                )
                enhanced_response["response"] = enhanced_response_with_links
                enhanced_response["links_enhanced"] = (
                    enhanced_response_with_links
            ...
            self._log_conversation_turn_to_bigquery(
                ...
                metadata={
                    ...
                    "links_enhanced": enhanced_response.get(
