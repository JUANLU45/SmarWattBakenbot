...
class EnterpriseGenerativeChatService:
    ...
    def _build_enterprise_system_instruction(self) -> str:
        ...
        return (
            ...
            "PERSONALIDAD Y TONO:\n"
            "- Conversación natural y cercana, como un experto en energía hablando con un amigo\n"
            ...
            "- 'Hola [NOMBRE], veo que con Naturgy estás pagando 171€/mes...'\n"
            "- 'Tu tarifa actual \"Tarifa Por Uso Luz\" con Naturgy...'\n"
            "- 'Con tu consumo de 801 kWh/mes podrías ahorrar X€ cambiando a...'\n\n"
            "NUNCA:\n"
            ...
            "Eres un especialista premium que usa los datos reales del usuario para dar valor específico y personalizado."
        )
    ...
    def _consult_expert_bot(
        ...
        try:
            ...
            if not expert_bot_url:
                logging.error("❌ EXPERT_BOT_API_URL no configurada en producción")
                return {}

            recommendations_url = (
                f"{expert_bot_url}/api/v1/energy/tariffs/recommendations"
            )
