...
class EnterpriseConfig:
    ...
    # === VARIABLE PARA OPENWEATHER API - DATOS METEOROLÓGICOS REALES ===
    OPENWEATHER_API_KEY = os.environ.get("OPENWEATHER_API_KEY")

    # === VARIABLE PARA ESIOS API - SE USA DESDE GOOGLE SECRET MANAGER ===
    # Nota: ESIOS_API_TOKEN se obtiene desde Secret Manager en esios_tariff_updater.py
    ESIOS_API_TOKEN = os.environ.get("ESIOS_API_TOKEN")  # Solo para documentación
